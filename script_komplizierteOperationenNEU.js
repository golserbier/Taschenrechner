...
function kompOp(Operation)
{
    if(OpWait != 0) {
        alert('Fehler: Eingabe nicht möglich');
        return;
    }
    switch(Operation)
    {
        ...
        case 6:
            ...
            break;
        default:
            alert('Error: kompOp: switch: default');
            break;
    }
}
function kompOpEnter()
{
    switch (OpWait) {
        case 1:
            Eingabewert = Math.log(Eingabewert);
            break;
        case 2:
            Eingabewert = Math.log10(Eingabewert);
            break;
        case 3:
            Eingabewert = Math.sqrt(Eingabewert);
            break;
        case 4:
            Eingabewert = Math.sin(Eingabewert);
            break;
        case 5:
            Eingabewert = Math.cos(Eingabewert);
            break;
        case 6:
            Eingabewert = Math.sin(Eingabewert) / Math.cos(Eingabewert);
            break;
        default:
            alert('Error: kompOpEnter: switch: default')
            break;
    }
    math();
    OpWait=0;
